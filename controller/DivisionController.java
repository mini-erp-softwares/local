...
public class DivisionController {
     ...
     * Save.
     *
     * @param plant the division
     * @return the division
     */
    // to add new material
    @ApiOperation(value = "save division", httpMethod = "POST")
    @ApiResponses(value = {
    		@ApiResponse(code = HttpURLConnection.HTTP_OK, message = "The request has been successfully processed.", response = Division.class),
    		@ApiResponse(code = HttpURLConnection.HTTP_UNAUTHORIZED, message = "Unauthorized", response = ExceptionModel.class),
    		@ApiResponse(code = HttpURLConnection.HTTP_NOT_FOUND, message = "Not found", response = ExceptionModel.class),
    		@ApiResponse(code = HttpURLConnection.HTTP_FORBIDDEN, message = "Access denied", response = ExceptionModel.class),
    		@ApiResponse(code = 200, message = "The request has been successfully processed and teh validation response is sent to client as required.", response=Division.class),
    		@ApiResponse(code = 202, message = "The request has been accepted and the validation response is sent to the client as required.", response=Division.class)
    })
    ...
    public Division save(
    		...
    		@RequestBody Division plant){
    	logger.info("Saving Division code");
        return divisionService.save(plant);
    }
    ...
    public Division update(Division plant){
    	logger.info("Update plant ");
        return divisionService.update(plant);
    }
    ...
    public java.util.List<Division> listplant() {
    	logger.info("getting List of Division");
