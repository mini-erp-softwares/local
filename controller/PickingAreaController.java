...
public class PickingAreaController {
	...
	/** The Constant logger. */
	private static final Logger logger = LogManager.getLogger(PickingAreaController.class);

    /** The pickingArea service. */
    @Autowired
    private PickingAreaService pickingAreaService;

    /**
     * Save.
     *
     * @param plant the pickingArea
     * @return the pickingArea
     */
    // to add new material
    @ApiOperation(value = "save pickingArea", httpMethod = "POST")
    @ApiResponses(value = {
    		@ApiResponse(code = HttpURLConnection.HTTP_OK, message = "The request has been successfully processed.", response = PickingArea.class),
    		@ApiResponse(code = HttpURLConnection.HTTP_UNAUTHORIZED, message = "Unauthorized", response = ExceptionModel.class),
    		@ApiResponse(code = HttpURLConnection.HTTP_NOT_FOUND, message = "Not found", response = ExceptionModel.class),
    		@ApiResponse(code = HttpURLConnection.HTTP_FORBIDDEN, message = "Access denied", response = ExceptionModel.class),
    		@ApiResponse(code = 200, message = "The request has been successfully processed and teh validation response is sent to client as required.", response=PickingArea.class),
    		@ApiResponse(code = 202, message = "The request has been accepted and the validation response is sent to the client as required.", response=PickingArea.class)
    })
    @PostMapping(path = "save", consumes=MediaType.APPLICATION_JSON_VALUE, produces=MediaType.APPLICATION_JSON_VALUE)
    public PickingArea save(
    		...
    		@RequestBody PickingArea plant){
    	logger.info("Saving PickingArea code");
        return pickingAreaService.save(plant);
    }
    ...
    public PickingArea update(PickingArea plant){
    	logger.info("Update plant ");
        return pickingAreaService.update(plant);
    }
    ...
    public java.util.List<PickingArea> listplant() {
    	logger.info("getting List of PickingArea");
        return pickingAreaService.findAll();
    }
    ...
    public void delete(@RequestParam("id")String id){
    	logger.info("Delete PickingArea ");
